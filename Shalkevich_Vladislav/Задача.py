    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                print("Вы с гордостью и медалью со школьной алимпиады по математике 'Зубрёнок'....за 3-й класс.."
                      "взялись за решения уровнения")
                discr = b ** 2 -4 * a * c
                if discr > 0:
        ...
        continue
print()
print("печатляет, вы сделали это и получаете от нашего банка 10000 долларов на 20 лет, без процентов")
